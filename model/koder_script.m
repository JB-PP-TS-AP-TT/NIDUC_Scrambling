...
esignal=randi([0,1],1,127); %generuje stu-bitowy sygna³ w zakresie od 0 do 1. Normalnie bêdzie tu wchodzi³ ca³y wygenerowany sygna³
preambule = [0 1];

disp(esignal); % wyswietlenie sygnalu przed kodowaniem
temp=1;
org_signal_size = length(esignal);
newesignal=[]; %bedzie zbierala 66 bitowymi kawa³kami preambu³e+sygna³ wejsciowy
